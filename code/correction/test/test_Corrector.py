...
class SentencePathTest(unittest.TestCase):
    ...
    def test_sentence_path(self):
        ...
        assert repr(path) == "<SentencePath [('This', -0.7)]>", path
        assert repr(new_path) == "<SentencePath [('This', -0.7), ('is', -0.8)]>", new_path
        assert repr(newer_path) == "<SentencePath [('This', -0.7), ('is', -0.8), ('fun', -1.1)]>", newer_path
